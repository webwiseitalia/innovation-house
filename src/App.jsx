...
function App() {
  ...
  return (
    <div className="noise-bg relative">
      ...
      <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-700 ${scrolled ? 'bg-[#0c0c0c]/80 backdrop-blur-2xl' : ''}`}>
        <div className="flex items-center justify-between h-14 md:h-16 px-6 md:px-10 lg:px-16">
          ...
          <div className="hidden lg:flex items-center gap-12">
            {navLinks.map((l) => (
              <button key={l.id} onClick={() => scrollTo(l.id)} className="font-body text-[11px] tracking-[0.2em] uppercase text-white/30 hover:text-[#c8956c] transition-colors duration-500">
                {l.label}
              </button>
            ))}
          </div>
        ...
        <div className="relative z-10 min-h-screen flex flex-col justify-end pb-16 md:pb-24 pt-32">
          <div className="px-6 md:px-10 lg:px-16">
            <div className="max-w-[920px]">
              ...
              <p className="hero-sub font-body text-white/50 text-base md:text-lg leading-[1.8] max-w-md md:ml-[8vw] mb-12">
              ...
              <div className="flex flex-wrap items-end gap-6 md:gap-12">
                ...
                <div className="hero-meta flex items-center gap-4">
                  ...
                  <span className="font-heading text-[40px] md:text-[56px] font-bold text-white/10 leading-none">9.1</span>
                  <div>
                    <span className="font-body text-[10px] tracking-[0.2em] uppercase text-white/30 block">Superb</span>
                    <span className="font-body text-[9px] text-white/15">bedandbreakfast.eu</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="hero-side-img hidden lg:block absolute top-[18vh] right-[4vw] w-[28vw] max-w-[380px]">
            ...
            <p className="font-body text-[9px] tracking-[0.3em] uppercase text-white/20 mt-4 text-right">La piscina · Vista Golfo</p>
          </div>
        </div>
      </section>
            ...
            <div key={rep} className="flex items-center gap-8 md:gap-12">
              {['Vista Mare', 'Piscina', 'Cinque Terre · 8 min', 'Parcheggio Gratuito', 'Golfo dei Poeti', '9.1/10 Superb', 'Pet Friendly'].map((t, i) => (
                <span key={`${rep}-${i}`} className="flex items-center gap-4 md:gap-6">
                  <span className="font-heading text-[11px] md:text-xs tracking-[0.3em] uppercase text-white/20">{t}</span>
      ...
      {/* ═══════════════════════ LA STRUTTURA ═══════════════════════ */}
      <section id="struttura" className="relative py-32 md:py-48 overflow-hidden">
        <div className="px-6 md:px-10 lg:px-16">
          ...
          <div className="relative">
            ...
            <div className="str-text-block md:w-[42%] lg:w-[35%]">
              <p className="font-body text-white/40 text-[15px] md:text-base leading-[2] mb-8">
              ...
              <p className="font-body text-white/25 text-sm leading-[2] mb-16">
              ...
              <div className="space-y-6">
                {['Posizione panoramica con vista mare', 'Atmosfera rilassante', 'Base ideale per escursioni', 'Parcheggio privato gratuito'].map((t, i) => (
                  <div key={t} className="flex items-start gap-5 group">
                    ...
                    <span className="font-body text-white/50 text-sm group-hover:text-white/80 transition-colors duration-500">{t}</span>
                  </div>
                ))}
              </div>
              ...
              <div className="mt-24 md:mt-32 border-l-2 border-[#c8956c]/30 pl-8">
                ...
                <span className="font-heading text-white/60 text-lg font-light tracking-wide block mt-2">&ldquo;Superb&rdquo;</span>
                <span className="font-body text-white/20 text-[10px] tracking-[0.3em] uppercase block mt-3">Bedandbreakfast.eu · 10 recensioni</span>
              </div>
            </div>
      ...
      {/* ═══════════════════════ LE CAMERE ═══════════════════════ */}
      <section id="camere" className="py-32 md:py-48 bg-[#111111] relative">
        {/* Large ghost number */}
        ...
        <div className="px-6 md:px-10 lg:px-16 w-full relative z-10">
          ...
          <div className="md:text-right mb-16 md:mb-28">
            ...
            <p className="font-body text-white/25 text-sm mt-6 md:ml-auto max-w-md leading-[1.9]">
              ...
              <div key={room.name} className="border-b border-white/[0.06]">
                ...
                >
                  <div className="flex items-baseline gap-4 md:gap-8">
                    ...
                    <span className={`font-heading text-xl md:text-3xl font-light tracking-wide transition-colors duration-500 ${expandedRoom === idx ? 'text-[#c8956c]' : 'text-white/60 group-hover:text-white/90'}`}>
                      {room.name}
                    </span>
                  </div>
                  <div className="flex items-center gap-6">
                    <span className="hidden md:block font-body text-[10px] tracking-[0.2em] uppercase text-white/20">{room.tagline}</span>
                    {expandedRoom === idx ? (
                        ...
                        <div className="grid grid-cols-12 gap-4 md:gap-6">
                          ...
                          <div className="col-span-12 md:col-span-5 md:col-start-8 md:-mt-[180px] relative z-10">
                            <div className="bg-[#0c0c0c]/90 backdrop-blur-sm border border-white/[0.05] p-8 md:p-10">
                              <p className="font-body text-white/40 text-sm leading-[1.9] mb-8">{room.description}</p>
                              <div className="grid grid-cols-2 gap-x-6 gap-y-3 mb-8">
                                {room.features.map((f) => (
                                  <div key={f} className="flex items-center gap-3">
                                    <span className="w-3 h-[1px] bg-[#c8956c]/50" />
                                    <span className="font-body text-white/50 text-xs">{f}</span>
                                  </div>
                                ))}
                              </div>
          ...
          <div className="mt-20 md:mt-28 flex flex-wrap gap-x-6 md:gap-x-10 gap-y-2">
            {['Lenzuola', 'Asciugamani', 'Asciugacapelli', 'Set cortesia', 'Armadio', 'TV', 'A/C', 'WiFi'].map((item, i) => (
              <span key={item} className="font-body text-white/15 text-[10px] tracking-[0.2em] uppercase">{item}</span>
            ))}
          </div>
        </div>
      </section>
      ...
      {/* ═══════════════════════ SERVIZI ═══════════════════════ */}
      <section id="servizi" className="py-32 md:py-48 px-6 md:px-10 lg:px-16 relative overflow-hidden">
        ...
        <div className="w-full relative z-10">
          ...
          <div className="mb-20 md:mb-32 flex flex-col md:flex-row md:items-end md:justify-between gap-8">
            ...
            <p className="font-body text-white/25 text-sm max-w-xs leading-[2] md:pb-2">
              Ogni servizio incluso. Nessun costo nascosto.
            </p>
          </div>

          {/* Services — irregular grid, not uniform cards */}
          <div className="srv-grid grid grid-cols-2 md:grid-cols-4 gap-[1px] bg-white/[0.04]">
            {services.map((s, i) => {
              const Icon = s.icon
              return (
                <div key={s.title} className={`srv-item bg-[#0c0c0c] p-7 md:p-10 group hover:bg-[#151515] transition-all duration-700 ${i === 2 ? 'md:col-span-2 md:row-span-1' : ''}`}>
                  ...
                  <h3 className="font-heading text-sm md:text-base text-white/70 group-hover:text-white/90 font-medium mb-1 transition-colors duration-500">{s.title}</h3>
                  <p className="font-body text-[11px] text-white/20 group-hover:text-white/35 transition-colors duration-500">{s.desc}</p>
                </div>
              )
            })}
          </div>
          ...
          <div className="mt-14 flex items-center gap-5">
            ...
            <p className="font-body text-[11px] text-white/20 tracking-[0.15em]">Lingue parlate: Italiano · English · Español</p>
          </div>
        </div>
      </section>
      ...
      {/* ═══════════════════════ POSIZIONE ═══════════════════════ */}
      <section id="posizione" className="py-32 md:py-48 px-6 md:px-10 lg:px-16">
          ...
          <div className="grid grid-cols-12 gap-6 md:gap-10">
            ...
            <div className="pos-info col-span-12 md:col-span-5 md:pt-24">
              <div className="space-y-0">
                {[
                  ...
                  <div key={item.place} className="flex items-baseline justify-between py-5 border-b border-white/[0.05] group hover:border-[#c8956c]/20 transition-colors">
                    <div>
                      <span className="font-heading text-sm font-medium text-white/60 group-hover:text-white/90 transition-colors block">{item.place}</span>
                      <span className="font-body text-[10px] text-white/20 block mt-1">{item.note}</span>
                    </div>
              ...
              <div className="mt-14 border border-white/[0.04] p-8">
                <h4 className="font-heading text-xs font-medium text-white/50 mb-5 tracking-wide">Come raggiungerci</h4>
                <div className="space-y-3 font-body text-[13px] text-white/30 leading-[1.9]">
                  <p><span className="text-white/60">Auto:</span> Uscita A12 La Spezia — seguire per Pianello</p>
                  <p><span className="text-white/60">Treno:</span> La Spezia Centrale, poi taxi (5 km)</p>
                  <p><span className="text-white/60">Aereo:</span> Pisa (87 km) o Genova (100 km)</p>
                </div>
      ...
      {/* ═══════════════════════ TERRITORIO ═══════════════════════ */}
      <section id="territorio" className="py-32 md:py-48 relative overflow-hidden">
        ...
        <div className="px-6 md:px-10 lg:px-16 w-full relative z-10">
          <div className="mb-20 md:mb-36">
            ...
            <p className="font-body text-white/25 text-base max-w-lg leading-[2] mt-8 md:ml-[12vw]">
              Un territorio amato da Byron, Shelley, Montale e D&apos;Annunzio
            </p>
          </div>

          {/* Territory — broken grid with images */}
          <div className="grid grid-cols-12 gap-5 md:gap-6">
            {/* Cinque Terre — large, left */}
            <div className="ter-card col-span-12 md:col-span-7 border border-white/[0.05] hover:border-[#c8956c]/15 transition-all duration-700 bg-[#0c0c0c]/60 backdrop-blur-sm overflow-hidden">
              <img src={heroImg} alt="Vista aerea Golfo" className="w-full h-[200px] md:h-[260px] object-cover" />
              <div className="p-8 md:p-14">
                ...
                <p className="font-body text-white/30 text-sm leading-[2] mt-6 max-w-lg">
            ...
            {/* Portovenere — smaller, offset down */}
            <div className="ter-card col-span-12 md:col-span-5 md:mt-20 border border-white/[0.05] hover:border-[#c8956c]/15 transition-all duration-700 bg-[#0c0c0c]/60 backdrop-blur-sm overflow-hidden">
              <img src={stoneEntryImg} alt="Architettura ligure" className="w-full h-[180px] object-cover" />
              <div className="p-8 md:p-12">
                ...
                <span className="font-body text-[9px] tracking-[0.4em] uppercase text-[#c8956c]/50">Patrimonio UNESCO</span>
                <p className="font-body text-white/30 text-sm leading-[2] mt-6">
                  Borgo medievale con la chiesa di San Pietro. Isole Palmaria, Tino e Tinetto.
                </p>
              </div>
            </div>

            {/* Lerici — medium, pushed left */}
            <div className="ter-card col-span-12 md:col-span-5 md:-mt-12 border border-white/[0.05] hover:border-[#c8956c]/15 transition-all duration-700 bg-[#0c0c0c]/60 backdrop-blur-sm overflow-hidden">
              <img src={stairsImg} alt="Scalinata nel giardino" className="w-full h-[180px] object-cover" />
              <div className="p-8 md:p-12">
            ...
            {/* Escursioni — wide, offset right */}
            <div className="ter-card col-span-12 md:col-span-7 border border-white/[0.05] hover:border-[#c8956c]/15 transition-all duration-700 bg-[#0c0c0c]/60 backdrop-blur-sm overflow-hidden">
              <img src={pondImg} alt="Natura e giardini" className="w-full h-[200px] md:h-[240px] object-cover" />
              <div className="p-8 md:p-14">
          ...
          <div className="mt-24 md:mt-32 border-t border-white/[0.04] pt-10">
            <h3 className="font-heading text-base text-white/30 font-light mb-6 tracking-wide">La Spezia</h3>
            <div className="flex flex-wrap gap-x-6 md:gap-x-10 gap-y-3">
              {['Museo Amedeo Lia', 'Museo Tecnico Navale', 'Castello San Giorgio', 'CAMEC', 'Museo del Sigillo', 'Passeggiata Morin', 'Via del Prione', 'Arsenale Militare'].map((p) => (
                <span key={p} className="font-body text-white/15 text-[11px] tracking-[0.1em] hover:text-white/40 transition-colors duration-500 cursor-default">{p}</span>
              ))}
            </div>
          </div>
        </div>
      ...
      {/* ═══════════════════════ CONTATTI ═══════════════════════ */}
      <section id="contatti" className="py-32 md:py-48 px-6 md:px-10 lg:px-16">
        <div className="w-full">
          ...
          <div className="grid grid-cols-12 gap-8 md:gap-16">
            ...
            <div className="contact-form-wrap col-span-12 lg:col-span-7">
              <form onSubmit={handleSubmit} className="space-y-7">
                <div className="grid md:grid-cols-2 gap-7">
                  <div>
                    <label className="block font-heading text-[10px] tracking-[0.2em] uppercase text-white/30 mb-3">Nome *</label>
                  ...
                  <div>
                    <label className="block font-heading text-[10px] tracking-[0.2em] uppercase text-white/30 mb-3">Email *</label>
                ...
                <div>
                  <label className="block font-heading text-[10px] tracking-[0.2em] uppercase text-white/30 mb-3">Telefono</label>
                ...
                <div className="grid grid-cols-3 gap-7">
                  <div>
                    <label className="block font-heading text-[10px] tracking-[0.2em] uppercase text-white/30 mb-3">Check-in *</label>
                  ...
                  <div>
                    <label className="block font-heading text-[10px] tracking-[0.2em] uppercase text-white/30 mb-3">Check-out *</label>
                  ...
                  <div>
                    <label className="block font-heading text-[10px] tracking-[0.2em] uppercase text-white/30 mb-3">Ospiti</label>
                ...
                <div>
                  <label className="block font-heading text-[10px] tracking-[0.2em] uppercase text-white/30 mb-3">Camera</label>
                ...
                <div>
                  <label className="block font-heading text-[10px] tracking-[0.2em] uppercase text-white/30 mb-3">Richieste</label>
                ...
                <div className="flex items-start gap-3 pt-2">
                  ...
                  <label className="font-body text-[11px] text-white/25 leading-relaxed">
            ...
            <div className="contact-side col-span-12 lg:col-span-4 lg:col-start-9 space-y-10 lg:pt-12">
              {/* Atmospheric photo */}
              <div className="overflow-hidden">
                <img src={poolImg} alt="Piscina Innovation House" className="w-full h-[220px] object-cover cursor-pointer hover:scale-[1.03] transition-transform duration-700" onClick={() => setLightbox({ open: true, img: poolImg, alt: 'Piscina Innovation House' })} />
              </div>

              <div>
                <h3 className="font-heading text-[10px] tracking-[0.35em] uppercase text-white/30 mb-6">Indirizzo</h3>
                <p className="font-body text-white/50 text-sm leading-[2]">
              ...
              <div>
                <h3 className="font-heading text-[10px] tracking-[0.35em] uppercase text-white/30 mb-6">Politiche</h3>
                <div className="space-y-4">
                  {[
                    ...
                    <div key={p.l} className="flex justify-between border-b border-white/[0.04] pb-3">
                      <span className="font-body text-[11px] text-white/20">{p.l}</span>
                      <span className="font-body text-[11px] text-white/50 font-medium">{p.v}</span>
                    </div>
                  ))}
                </div>
              </div>
              ...
              <div className="border border-[#c8956c]/15 p-8">
                <p className="font-heading text-white/60 text-sm font-light tracking-wide leading-relaxed">
      ...
      {/* ═══════════════════════ FOOTER ═══════════════════════ */}
      <footer className="bg-[#060606] text-white py-20 md:py-28 px-6 md:px-10 lg:px-16">
        <div className="w-full">
          ...
          <div className="grid grid-cols-12 gap-8">
            <div className="col-span-12 md:col-span-4">
              <p className="font-body text-white/20 text-sm leading-[2] max-w-xs">
            ...
            <div className="col-span-6 md:col-span-3 md:col-start-6">
              <div className="space-y-3">
                {navLinks.map((link) => (
                  <button key={link.id} onClick={() => scrollTo(link.id)} className="block font-body text-white/20 hover:text-white/60 text-sm transition-colors">
                    {link.label}
                  </button>
                ))}
              </div>
            ...
            <div className="col-span-6 md:col-span-3">
              <div className="space-y-3 font-body text-white/20 text-sm">
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            <p className="font-body text-white/10 text-[10px] tracking-[0.15em]">
              © 2026 Innovation House — La Spezia
            </p>
            <div className="flex gap-8">
              <a href="#" className="font-body text-white/10 hover:text-white/30 text-[10px] tracking-[0.1em] transition-colors">Privacy Policy</a>
              <a href="#" className="font-body text-white/10 hover:text-white/30 text-[10px] tracking-[0.1em] transition-colors">Cookie Policy</a>
            </div>
          </div>
        </div>
      </footer>
